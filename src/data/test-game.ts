  ...
  runs: {
    'past-edition': {
      ...
      events: [
        ...
        {
          type: EventType.ChallengeCompleted,
          timestamp: relativeDate(-30, 15, 0),
          team: 'team-a',
        ...
        {
          type: EventType.ChallengeCompleted,
          timestamp: relativeDate(-30, 15, 30),
          team: 'team-a',
        ...
        {
          type: EventType.ChallengeCompleted,
          timestamp: relativeDate(-30, 15, 45),
          team: 'team-b',
        ...
        {
          type: EventType.ChallengeCompleted,
          timestamp: relativeDate(-30, 15, 50),
          team: 'team-b',
    ...
    'current-edition': {
      ...
      events: [
        ...
        {
          type: EventType.ChallengeCompleted,
          timestamp: relativeDate(0, 11, 25),
          team: 'team-d',
